...
import com.example.japanshop.entity.Category;
...
public class AccessoryDTO extends AbstractDTO<Integer> {
    ...
    public void setOrderDetailAccessories(java.util.List<com.example.japanshop.entity.OrderDetailAccessory> orderDetailAccessories) {
        this.orderDetailAccessories = orderDetailAccessories;
    }

    public java.util.List<com.example.japanshop.entity.OrderDetailAccessory> getOrderDetailAccessories() {
