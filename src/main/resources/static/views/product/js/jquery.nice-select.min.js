    ...
    e.fn.niceSelect = function (t) {
        function s(t) {
            ...
            s.find(".current").html(i.data("display") || i.text()), n.each(function (t) {
                ...
                s.find("ul").append(e("<li></li>").attr("data-value", n.val()).attr("ng-click", "checksortMinMax('"+n.val()+"')").attr("data-display", i || null).addClass("option" + (n.is(":selected") ? " selected" : "") + (n.is(":disabled") ? " disabled" : "")).html(n.text()))
            })
        }
